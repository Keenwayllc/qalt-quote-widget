          ...
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="px-6 py-6 space-y-5">
              <p className="text-slate-600 text-sm leading-relaxed">
                This will <strong className="text-slate-900">permanently delete</strong> your account, all quotes, widget settings, and cancel your subscription. There is no undo.
              </p>
              <div>
                ...
                <input
                  ...
                  placeholder="DELETE"
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-400"
                />
              </div>
