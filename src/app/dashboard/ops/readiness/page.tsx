  ...
  return (
    <div className="p-4 lg:p-10 max-w-6xl mx-auto space-y-6 sm:space-y-8">
      <div className="space-y-1">
        <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Delivery Readiness</h1>
        <p className="text-slate-500 font-medium text-sm sm:text-base">Confirm stops are prepared before dispatching. Verified deliveries have higher success rates.</p>
      </div>
